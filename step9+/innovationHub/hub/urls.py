...
from .views import projectDetails, index, listProjects, project_ListView, project_DetailView, project_CreateView, \
    deleteProjects, project_UpdateView, add_student, student_ListView, registerPage, loginPage, logoutUser
...
urlpatterns = [
    ...
    path('projects/details/<int:pk>/', project_DetailView.as_view(), name='projectDV'),
    ...
    path('projectsDV/update/<int:pk>/', project_UpdateView.as_view(), name='projectUpV'),
